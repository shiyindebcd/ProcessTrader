...
################################################################################
## Form generated from reading UI file 'CreateNewProcess_dark.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u":/\u56fe\u6807/icons/\u6700\u5c0f\u5316.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/\u56fe\u6807/icons/\u5173\u95ed.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.label_Customized_parameters1.setBuddy(self.symbol)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_tital_6.setText(QCoreApplication.translate("Form", u"\u521b\u5efa\u65b0\u7684\u7b56\u7565\u8fdb\u7a0b", None))
