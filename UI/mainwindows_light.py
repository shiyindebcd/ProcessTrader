...
"")
        ...
        self.process_list_page.setGeometry(QRect(0, 0, 218, 448))
...
"}")
        ...
        self.frame_17.setMaximumSize(QSize(400, 35))
        ...
        self.Btn_reload_process_config = QPushButton(self.frame_17)
