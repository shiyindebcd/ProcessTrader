...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QSize(1400, 800))
...
"}")
        ...
        self.verticalLayout_2 = QVBoxLayout(self.frame_93)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.upper_left_4.sizePolicy().hasHeightForWidth())
        self.upper_left_4.setSizePolicy(sizePolicy1)
        ...
        self.label_select_tq_account.setMaximumSize(QSize(200, 40))
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.upper_right_4.sizePolicy().hasHeightForWidth())
        self.upper_right_4.setSizePolicy(sizePolicy1)
...
"}")
        ...
        self.Btn_stop_backtest.setMinimumSize(QSize(200, 40))
        self.Btn_stop_backtest.setMaximumSize(QSize(200, 40))
...
"}")
        ...
        self.Btn_clear_backtest_parameters.setMinimumSize(QSize(200, 40))
        self.Btn_clear_backtest_parameters.setMaximumSize(QSize(200, 40))
...
"}")
        ...
        self.verticalLayout_3 = QVBoxLayout(self.frame_25)
...
"}")
        ...
        self.verticalLayout_8 = QVBoxLayout(self.frame_97)
        self.verticalLayout_8.setSpacing(20)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.frame_78 = QFrame(self.frame_97)
...
"}")
        ...
        self.frame_4 = QFrame(self.frame_78)
...
"}")
        ...
        self.horizontalLayout_45.addWidget(self.frame_4)

        self.frame_5 = QFrame(self.frame_78)
...
"}")
        ...
        self.horizontalLayout_45.addWidget(self.frame_5)


        self.verticalLayout_8.addWidget(self.frame_78, 0, Qt.AlignHCenter)
...
"}")
        ...
        self.horizontalLayout_55.setContentsMargins(10, 0, 10, 10)
        self.frame_94 = QFrame(self.frame_98)
        self.frame_94.setObjectName(u"frame_94")
        self.frame_94.setMinimumSize(QSize(0, 0))
        self.frame_94.setMaximumSize(QSize(240, 500))
        self.frame_94.setFrameShape(QFrame.StyledPanel)
        self.frame_94.setFrameShadow(QFrame.Raised)
        self.verticalLayout_6 = QVBoxLayout(self.frame_94)
...
"}")
        ...
        self.calendar_backtest_startdate.setMinimumSize(QSize(210, 240))
        self.calendar_backtest_startdate.setMaximumSize(QSize(210, 240))
...
"}")
        ...
        self.verticalLayout_6.addWidget(self.calendar_backtest_startdate, 0, Qt.AlignHCenter)
...
"}")
        ...
        self.verticalLayout_6.addWidget(self.label_backtest_startdate, 0, Qt.AlignHCenter)
        ...
        self.frame_95.setMaximumSize(QSize(240, 500))
        self.frame_95.setFrameShape(QFrame.StyledPanel)
        self.frame_95.setFrameShadow(QFrame.Raised)
        self.verticalLayout_7 = QVBoxLayout(self.frame_95)
...
"}")
        ...
        self.calendar_backtest_enddate.setMinimumSize(QSize(210, 240))
        self.calendar_backtest_enddate.setMaximumSize(QSize(210, 240))
...
"}")
        ...
        self.verticalLayout_7.addWidget(self.calendar_backtest_enddate, 0, Qt.AlignHCenter)
...
"}")
        ...
        self.verticalLayout_7.addWidget(self.label_backtest_enddate, 0, Qt.AlignHCenter)


        self.horizontalLayout_55.addWidget(self.frame_95, 0, Qt.AlignHCenter)


        self.verticalLayout_8.addWidget(self.frame_98)
