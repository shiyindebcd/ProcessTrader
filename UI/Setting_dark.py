...
################################################################################
## Form generated from reading UI file 'Setting_dark.ui'
##
...
"")
        ...
        self.label_2.setMaximumSize(QSize(280, 40))
...
"")
        ...
        sizePolicy1.setHeightForWidth(self.Btn_clear_input.sizePolicy().hasHeightForWidth())
        self.Btn_clear_input.setSizePolicy(sizePolicy1)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Btn_Determine_add.sizePolicy().hasHeightForWidth())
        self.Btn_Determine_add.setSizePolicy(sizePolicy2)
