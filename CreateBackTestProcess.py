...
################################################################################
## Form generated from reading UI file 'CreateBackTestProcess.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QSize(1500, 800))
        Form.setMaximumSize(QSize(1500, 802))
...
"}")
        icon = QIcon()
        icon.addFile(u":/\u56fe\u6807/icons/chrome.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/\u56fe\u6807/icons/\u6700\u5c0f\u5316.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/\u56fe\u6807/icons/\u5173\u95ed.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.label_backtest_stop_loss = QLabel(self.upper_left_6)
...
"}")
        ...
        self.verticalLayout_53.addWidget(self.label_backtest_stop_loss)

        self.label_backtest_stop_profit = QLabel(self.upper_left_6)
...
"}")
        ...
        self.verticalLayout_53.addWidget(self.label_backtest_stop_profit)
...
"}")
        ...
        self.frame_98.setMinimumSize(QSize(0, 500))
...
"}")
        ...
        self.frame_99.setMinimumSize(QSize(0, 80))
        self.frame_99.setMaximumSize(QSize(16777215, 80))
...
"}")
        ...
        self.frame_77.setMinimumSize(QSize(0, 80))
        self.frame_77.setMaximumSize(QSize(16777215, 80))
...
"}")
        ...
        self.label_backtest_select_tq_account.setBuddy(self.comboBox_select_tq_account)
        self.label_backtest_select_strategy.setBuddy(self.comboBox_select_strategy)
        self.label_backtest_exchange.setBuddy(self.comboBox_exchange)
        self.label_backtest_symbol.setBuddy(self.symbol)
        self.label_backtest_symbol_period.setBuddy(self.symbol_period)
        self.label_backtest_initial_capital.setBuddy(self.initial_capital)
        self.label_backtest_web_port.setBuddy(self.web_port)
        self.label_backtest_orientation.setBuddy(self.orientation)
        self.label_backtest_contract_multiples.setBuddy(self.contract_multiples)
        self.label_backtest_margin_rate.setBuddy(self.margin_rate)
        self.label_backtest_stop_loss.setBuddy(self.stop_loss)
        self.label_backtest_stop_profit.setBuddy(self.stop_profit)
        ...
        QWidget.setTabOrder(self.Customized_parameters8, self.calendar_backtest_startdate)
        QWidget.setTabOrder(self.calendar_backtest_startdate, self.calendar_backtest_enddate)
        QWidget.setTabOrder(self.calendar_backtest_enddate, self.Btn_start_backtest)
        QWidget.setTabOrder(self.Btn_start_backtest, self.Btn_clear_backtest_parameters)
        QWidget.setTabOrder(self.Btn_clear_backtest_parameters, self.Btn_open_with_chrome)
        QWidget.setTabOrder(self.Btn_open_with_chrome, self.Btn_close_window)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_backtest_symbol_period.setText(QCoreApplication.translate("Form", u"\u5408\u7ea6\u5468\u671f", None))
        self.label_backtest_initial_capital.setText(QCoreApplication.translate("Form", u"\u7b56\u7565\u521d\u59cb\u8d44\u91d1", None))
        self.label_backtest_web_port.setText(QCoreApplication.translate("Form", u"web\u7aef\u53e3\u53f7", None))
        self.label_backtest_orientation.setText(QCoreApplication.translate("Form", u"\u4ea4\u6613\u65b9\u5411", None))
        self.label_backtest_contract_multiples.setText(QCoreApplication.translate("Form", u"\u5408\u7ea6\u500d\u6570", None))
        self.label_backtest_margin_rate.setText(QCoreApplication.translate("Form", u"\u4fdd\u8bc1\u91d1\u7387\uff08%\uff09", None))
        ...
        self.label_backtest_stop_loss.setText(QCoreApplication.translate("Form", u"\u6b62\u635f\u4f4d\uff08%\uff09", None))
        self.label_backtest_stop_profit.setText(QCoreApplication.translate("Form", u"\u6b62\u76c8\u4f4d\uff08%\uff09", None))
